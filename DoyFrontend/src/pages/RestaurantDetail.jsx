...
import restaurantMenu from "../services/restaurantMenu";
...
const RestaurantDetail = () => {
    ...
    // Önceki location.state'i simüle etmek için localStorage kullanabiliriz
    ...
    // darkMode değiştiğinde localStorage'a kaydet
    useEffect(() => {
    ...
    const handleConfirm = () => {
        if (cart.length > 0) {
            // Cart bilgisini localStorage'a kaydediyoruz
            localStorage.setItem("cartItems", JSON.stringify(cart));
            localStorage.setItem("restaurant", JSON.stringify(restaurant));
            
            // Wouter ile navigasyon (yönlendirme)
            setLocation("/cart");
        } else {
            alert("Sepetiniz boş.");
        }
            ...
            <div style={{
                ...
                <div
                    ...
                    <div style={{
                        ...
                        <button onClick={() => setLocation("/auth")} style={{ padding: "0.3rem 0.8rem", backgroundColor: "#F8F5DE", color: "#000", fontWeight: "bold", border: "none", borderRight: "1px solid #ccc", cursor: "pointer" }}>KAYIT</button>
                        <button onClick={() => setLocation("/auth")} style={{ padding: "0.3rem 0.8rem", backgroundColor: "#F8F5DE", color: "#000", fontWeight: "bold", border: "none", cursor: "pointer" }}>GİRİŞ</button>
                    </div>
                </div>
            </div>
