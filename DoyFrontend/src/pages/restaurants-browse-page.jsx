...
import { Moon, Search, Star, MapPin, ChevronRight, Utensils, Filter, Clock, TrendingUp, Heart } from "lucide-react"
import { motion, AnimatePresence } from "framer-motion"
import useRestaurantApi from "../services/useRestaurantApi" // Import the custom hook
...
export default function RestaurantsPage() {
  ...
  const sortedRestaurants = () => {
    ...
    switch(sortBy) {
      ...
      case 'minOrder':
        return [...restaurants].sort((a, b) => {
          const aAmount = parseInt(a.minOrderAmount);
          const bAmount = parseInt(b.minOrderAmount);
  ...
  return (
    <div className={`flex flex-col min-h-screen ${darkMode ? "bg-gray-900 text-white" : "bg-[#47300A] text-gray-800"}`}>
      {/* Header section */}
      <motion.header
      ...
      <div className={`${darkMode ? "bg-gray-900" : "bg-amber-50"} py-8 px-6 sticky top-0 z-20 ${darkMode ? "shadow-gray-800/30" : "shadow-amber-800/10"} shadow-md`}>
                  ...
                  >
                    ...
                    <div className="p-3">
                      ...
                      <div className="flex items-center justify-between mt-2 text-xs">
                        ...
                        <span className={restaurant.deliveryFee === "Ücretsiz" 
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              >
                {searchQuery ? `"${searchQuery}" için Sonuçlar` : 
                 selectedCategory ? `${selectedCategory} Restoranları` :
                  ...
                  >
                    ...
                    >
                      ...
                      {!restaurant.isOpen && (
                        <div className="absolute inset-0 bg-black bg-opacity-60 flex items-center justify-center">
                          <span className="text-white text-xs font-bold px-2 py-1 bg-gray-900 bg-opacity-80 rounded">KAPALI</span>
                        </div>
                      )}
                    </motion.div>
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center gap-4 mt-1 mb-2">
                        ...
                        <motion.span
                          className={`text-xs ${restaurant.deliveryFee === "Ücretsiz" ? 
                            (darkMode ? "text-green-400" : "text-green-600") : 
                            (darkMode ? "text-gray-400" : "text-gray-600")
                          }`}
                          initial={{ opacity: 0 }}
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        <motion.button
                          onClick={(e) => {
                            e.stopPropagation();
                            handleOrderClick(restaurant.id);
                          }}
                        ...
                        >
                          {restaurant.isOpen ? "Sipariş Ver" : "Şu Anda Kapalı"}
                        </motion.button>
                        {restaurant.hasDiscount && (
                          <motion.span
