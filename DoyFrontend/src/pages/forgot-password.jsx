...
export default function ForgotPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Mock API call - in a real app, you would send a password reset request to an API
      if (email) {
        // Simulate API delay
        await new Promise((resolve) => setTimeout(resolve, 1500))

        // Show success message and change step
      ...
      setErrorMessage("Şifre sıfırlama isteği sırasında bir hata oluştu. Lütfen tekrar deneyin.")
    ...
    <div className={`flex flex-col min-h-screen ${darkMode ? "bg-gray-900" : "bg-[#f5f0e1]"}`}>
      ...
      <div className="flex-grow flex justify-center items-start p-4">
        <div className="w-full max-w-md bg-white rounded-lg p-6 shadow-md">
          <h2 className="text-center text-xl font-semibold text-[#5c4018] mb-6">Şifremi Unuttum</h2>
          ...
          {step === "request" ? (
            ...
            >
              ...
              <div className="text-center text-sm text-gray-600 pt-2">
                <Link
                  href="/auth?tab=login"
                  className="text-[#5c4018] hover:underline font-medium flex items-center justify-center gap-1"
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <div className="bg-green-50 border-l-4 border-green-500 text-green-700 p-4 rounded-lg shadow-sm">
                <div className="flex">
                  <div className="py-1">
                    <svg
              ...
              <p className="text-gray-600">
                Lütfen e-postanızı kontrol edin ve şifrenizi sıfırlamak için gönderilen bağlantıya tıklayın. Eğer
                e-posta gelmezse, spam klasörünüzü kontrol edin veya tekrar deneyin.
              </p>

              <div className="flex flex-col space-y-3">
                <Button
                  onClick={() => setStep("request")}
                  className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium py-2 rounded-md flex items-center justify-center gap-2"
                >
                  Tekrar Dene
                </Button>
