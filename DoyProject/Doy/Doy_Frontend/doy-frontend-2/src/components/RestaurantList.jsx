...
const RestaurantList = ({ restaurants, setSelectedRestaurant, selectedRestaurant, darkMode }) => {
    ...
    const restaurantsToDisplay = showAll ? filteredRestaurants : filteredRestaurants.slice(0, 4);
