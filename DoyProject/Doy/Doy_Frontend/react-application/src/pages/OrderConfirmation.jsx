...
const OrderConfirmation = () => {
    ...
    const deliveryAddress = state?.address || "Adres belirtilmedi";
    ...
    return (
        <div style={{ backgroundColor: darkMode ? "#1a1a1a" : "#F2E8D6", minHeight: "100vh", padding: "2rem", display: "flex", flexDirection: "column" }}>
            {/* Üst bar */}
            ...
            {/* Sipariş Onayı */}
            <div style={{ backgroundColor: darkMode ? "#2c2c2c" : "#fff", color: darkMode ? "#fff" : "#000", padding: "2rem", borderRadius: "20px", maxWidth: "700px", margin: "2rem auto", boxShadow: "0 0 10px rgba(0,0,0,0.1)", textAlign: "center" }}>
                ...
                <div style={{
                    ...
                    <p><strong>Sipariş Tarihi:</strong> {orderTime}</p>
                    <p><strong>Teslimat Adresi:</strong> {deliveryAddress}</p>
                    <p><strong>Tahmini Teslimat Süresi:</strong> {restaurant?.time ? `${restaurant.time} dakika` : "30-40 dakika"}
                    </p>
                ...
                {currentStatus === "Teslim Edildi ✅" && !showRating && (
                    <button onClick={() => setShowRating(true)} style={{ marginTop: "2rem", backgroundColor: "#6c4c9c", color: "white", padding: "0.75rem 1.5rem", border: "none", borderRadius: "12px", fontWeight: "bold", cursor: "pointer" }}>
                        ...
                        <div style={{ display: "flex", justifyContent: "center", gap: "0.5rem" }}>
                            {[1, 2, 3, 4, 5].map((num) => (
                                <FaStar
                                    ...
                                    style={{ cursor: "pointer", transition: "transform 0.2s", transform: num <= rating ? "scale(1.2)" : "scale(1)" }}
                                />
                            ))}
                        </div>
